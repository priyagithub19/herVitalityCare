...
export default function DashHome() {
  ...
  return (
    <Box sx={{ display: 'flex', backgroundColor: 'rgba(245, 181, 212, 0.3)', height: '100%' }}>
      <DashNav />
      <Box component="main" sx={{ flexGrow: 1, p: 3, mx: 2, pr: 0, overflow: 'scroll', overflowX: 'hidden', scrollbarWidth: 'none' }}>
        <Box sx={{ display: 'flex', flexDirection: 'row', gap: 1 }}>
          <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', height: '15rem', backgroundColor: 'rgba(235, 143, 188, 0.5)', p: 5, borderRadius: 5, boxShadow: 'inset 0 0 17px rgba(255, 255, 255, 0.7)', border: '1px solid rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(10px)', gap: 10 }}>
        ...
        <Grid container spacing={4} sx={{ mt: 5 }}>
          <Grid item xs={12} md={6} >
            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', gap: 2, alignItems: 'center', position: 'relative', bottom: 0, zIndex: 9999, mt: 0, opacity: open ? 0 : 1 }}>
                <Typography sx={{ color: '#c60066ff' }}>
                  There is no previous data found!
                </Typography>
                <Button component="a" sx={{ backgroundColor: '#E18AAA', '&:hover': { backgroundColor: '#f078a4ff' }, cursor: 'pointer' }}  href='/trackingPage'>
                  {plus}
                </Button>
                <Popover
                  id={id}
      ...
      >
        <DialogTitle style={{ cursor: 'move', fontWeight: 500 }} >
          Confirm First Day of Your Period
        </DialogTitle>
        <DialogContent>
          <DialogContentText>
            Starting Day is : {date}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button autoFocus onClick={handleClose} sx={{backgroundColor: '#fb9ec4', '&:hover': {backgroundColor: '#f77fb0'},}}>
            Cancel
          </Button>
          <Button onClick={handleClose} sx={{backgroundColor: '#ff6fa5', '&:hover': {backgroundColor: 'rgba(236, 121, 167, 1)'},}}>Confirm</Button>
        </DialogActions>
      </Dialog>
