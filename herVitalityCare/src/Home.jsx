...
export default function Home() {
  ...
  const infobox = [
    {id: 1, title: 'Menstrual Cycle (Normal Menstruation): Overview & Phases', image: cycle},
    {id: 2, title: 'All About Women’s Health| What to Eat & Drink to Stay Fit |Wellness assentials', image: podcast},
]
  const healthTips = [
           ...
           <Box className="herodiv">
                ...
                <Box sx={{display: 'flex', flexDirection: 'column', height: '100%'}}>
                  <Box sx={{backgroundColor: '#E5D8DA', padding: '0.3rem 1rem 1rem 1rem', borderRadius: '1.7rem', height: 'max-content', width: '100%', position: 'relative', '&:hover': { boxShadow: 'inset 0 0 8px #BD7689' }, cursor: 'pointer', marginBottom: '0.7rem',  }}>
                    ...
                    <Button className="rdmr" sx={{backgroundColor: '#F8EDED', color: '#000000', borderRadius: '0.5rem', fontSize: '0.4rem', position: 'absolute', bottom: '0.rem', right: '0rem', marginTop: '0.1rem'}}>{'Read More >'}</Button>
                  </Box>
